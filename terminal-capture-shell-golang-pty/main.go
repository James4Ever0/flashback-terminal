...
func main() {
	...
	case "__server":
		exitCode = cmd.ServerCmd(cfg, logger, subArgs)
	default:
...
func printUsage() {
	...
	fmt.Println("  capture                    Capture all sessions and upload changes")
	fmt.Println("  list                       List managed PTY sessions")
	...
	fmt.Println("  FLASHBACK_SHELL_PTY_SOCKET_DIR")
	...
	fmt.Println("  first_capture_delay, disable_capture, diff_only, diff_mode, text_only,")
	fmt.Println("  scrollback_lines, allow_nested")
	fmt.Println()
