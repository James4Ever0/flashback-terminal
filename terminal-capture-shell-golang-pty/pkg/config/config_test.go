...
socket_dir: "~/.flashback-shell-pty/sockets-from-config"
...
`
	...
	t.Setenv("FLASHBACK_SHELL_PTY_SOCKET_DIR", "~/.flashback-shell-pty/sockets-from-env")
	...
	checks := []struct {
		...
		{"socket_dir", cfg.SocketDir, src.SocketDir.Origin, filepath.Join(home, ".flashback-shell-pty", "sockets-from-env")},
