...
use crate::vt::buffer::{Buffer, EraseMode};
use crate::vt::cell::{Cell, Occupancy};
...
use crate::vt::pen::{Intensity, Pen};
use crate::vt::tabs::Tabs;
...
mod tests {
    ...
    use crate::vt::pen::Intensity;
    use crate::vt::pen::Pen;
    use Function::*;
    use SgrOp::*;
    ...
    fn execute_decstr() {
        ...
        assert_eq!(term.pen, crate::vt::pen::Pen::default());
    }
